  ...
  L.Polyline.include({
    ...
    updateMeasurements: function() {
      ...
      if (this._measurementOptions.showDistances && latLngs.length > 1) {
        ...
        if (!isPolygon) {
          L.marker
            .measurement(ll2, formatter(totalDist), options.lang.totalLength, 0, options)
            .addTo(this._measurementLayer);
        }
      }
      ...
      if (isPolygon && options.showArea && latLngs.length > 2) {
        ...
        L.marker
          .measurement(this.getBounds().getCenter(), formatter(area), options.lang.totalArea, 0, options)
          .addTo(this._measurementLayer);
      }
